...
/**
 * Data structure representing the reporting period boundaries used in a transaction report.
 * <p>
 * Encapsulates the start and end dates as formatted strings (typically ISO 8601) to clearly define
